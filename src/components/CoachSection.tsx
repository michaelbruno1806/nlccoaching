        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-muted-foreground leading-relaxed mb-8">
              {getContent("coach_bio_2") ||
                t(
                  "Depuis 2019 dans le domaine du coaching sportif et le développement personnel, j'ai développé une méthodologie unique qui combine science du sport, psychologie de la performance et accompagnement humain.",
            ...
            <div className="relative aspect-[3/4] max-w-md mx-auto">
              ...
              <div className="relative rounded-2xl overflow-hidden h-full">
                <img
                  ...
                  src="/lovable-uploads/f0173019-13b6-466d-9eaa-2c6f650b0dba.jpg"
                />
              </div>
            </div>
          </motion.div>
