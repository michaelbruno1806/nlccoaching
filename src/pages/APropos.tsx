      ...
      <section ref={heroRef} className="relative min-h-[70vh] flex items-center justify-center overflow-hidden pt-20">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          ...
          delay: 0.4
            ...
            {language === 'fr' ? "Coach sportif, préparateur physique & entraineur dans la métropole lilloise" : "Sports coach, physical trainer & coach in the Lille metropolitan area"}
          </motion.p>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            duration: 0.8
              ...
              <p className="text-muted-foreground leading-relaxed">
                {language === 'fr' ? "Notre mission : vous accompagner à reprendre le contrôle de votre corps, à perdre du poids durablement et à atteindre vos objectifs physiques sans blessure, grâce à un suivi structuré, exigeant et bienveillant." : "Our mission: to help you regain control of your body, lose weight sustainably and achieve your physical goals without injury, through structured, demanding and caring support."}
              </p>
            </motion.div>
            ...
            <div className="grid lg:grid-cols-5 gap-12 items-start">
              ...
              <div className="lg:col-span-3 space-y-8">
                ...
                delay: 0.2
                  ...
                  {language === 'fr' ? "Fondé par Noa Liam Politino, coach sportif, préparateur physique et entraineur installé dans la métropole lilloise, NLC Coaching s'appuie sur un parcours profondément ancré dans la culture du sport et de la performance." : "Founded by Noa Liam Politino, sports coach, physical trainer and coach based in the Lille metropolitan area, NLC Coaching relies on a background deeply rooted in the culture of sport and performance."}
                </motion.p>
                ...
                delay: 0.4
                  ...
                  {language === 'fr' ? "Après avoir passé son BPJEPS à 18 ans, puis une première année en Licence STAPS à 19 ans, il a choisi la voie du DJEPS dans les métiers de la force et de la coordination de projet sportif : une formation plus concrète, centrée sur la performance et l'entraînement." : "After passing his BPJEPS at 18, then a first year in a STAPS degree at 19, he chose the DJEPS path in strength professions and sports project coordination: a more concrete training, focused on performance and training."}
                </motion.p>
              </div>
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          duration: 0.8
            ...
            <h2 className="font-display text-4xl md:text-5xl font-bold mb-6">
              ...
              <span className="text-gradient px-[122px] mx-[166px]">{language === 'fr' ? 'coachs' : 'coaches'}</span>
            </h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="/formules" className="mx-[3px] px-[16px] text-right">
                <Button variant="gold" size="lg" className="group">
