...
import { ArrowLeft, Check, Users, Heart, Zap, Trophy, MessageCircle } from "lucide-react";
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <motion.form
              ...
              onSubmit={(e) => {
                e.preventDefault();
                window.open(
                  "https://wa.me/23058035450?text=Bonjour%2C%20je%20suis%20int%C3%A9ress%C3%A9%28e%29%20par%20le%20Small%20Groupes%20et%20j%E2%80%99aimerais%20avoir%20plus%20d%E2%80%99informations.",
                  "_blank"
                );
              }}
            >
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  ...
                  <Input placeholder={isFrench ? "Votre nom" : "Your name"} className="bg-card" />
                </div>
                <div>
                  <label className="text-sm text-muted-foreground mb-2 block">Email</label>
                  <Input type="email" placeholder="email@example.com" className="bg-card" />
                </div>
              </div>

              <div>
                <label className="text-sm text-muted-foreground mb-2 block">{isFrench ? "Téléphone" : "Phone"}</label>
                <Input placeholder="+33 6 12 34 56 78" className="bg-card" />
              </div>
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {objectives.map((obj) => (
                    <label
                      key={obj.id}
                      className="flex items-center gap-2 bg-card border border-border/50 rounded-lg px-4 py-2 cursor-pointer hover:border-primary/50 transition-colors"
                    >
                      <Checkbox id={obj.id} />
